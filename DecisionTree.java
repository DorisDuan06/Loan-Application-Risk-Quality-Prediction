 ...
 * The implementation is in the file DecisionTreeImpl.
 */
abstract class DecisionTree {
  ...
  /**
   * Print the information gain of each attribute as computed from creating the root node for the given DataSet.
   * 
   * Print each line with one attribute
   * the Attr_name then a space then the info gain use precision of 5 decimal places in output.
   * 
   * Example:
   * A1 0.12345
   * A2 0.45678 
