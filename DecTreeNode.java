...
/**
 * Possible class for internal organization of a decision tree. Included to show standardized output method, print().
 */
public class DecTreeNode {
   ...
   * 
   * For printing to be consistent, children should be added in order of the attribute values as specified in the dataset.
   */
